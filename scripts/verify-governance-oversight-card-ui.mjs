...
if(!workspace.includes('onTemplate={template=>{setDraft(template)'))throw new Error('OVERSIGHT-TEMPLATE-ACTIONS-MUST-FILL-COMPOSER');
if(!workspace.includes('onCommand={command=>void sendQuickCommand(command)}'))throw new Error('OVERSIGHT-EXPLICIT-ACTIONS-MUST-POST-THROUGH-CONVERSATION-API');
