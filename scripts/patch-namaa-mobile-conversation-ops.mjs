...
// Keep common governed actions inside the conversation context on phone. Anchor to
// the stable aria-label we introduced in the chat-first patch rather than the artifact's
// internal message-list element name.
replaceOnce(
  'src/components/ConversationWorkspace.tsx',
