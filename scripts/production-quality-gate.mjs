...
const steps = [
  ...
  ['final onboarding UI contract','node',['scripts/verify-final-onboarding-ui-contract.mjs']],
  ...
  ['financial form intelligence contract','node',['scripts/verify-financial-form-intelligence.mjs']],
  ...
  ['governed document and role edit contract','node',['scripts/verify-governed-document-contract.mjs']],
