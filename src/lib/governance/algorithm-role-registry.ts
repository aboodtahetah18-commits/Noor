...
export const ALGORITHM_ROLE_REGISTRY:readonly AlgorithmRoleRef[]=[
  {
    ...
    authorities:['تجميع التوصيات وطلب استكمالها','طلب بيانات أو تحليل إضافي قبل القرار','إحالة القرار لمحرك نماء عند تجاوز اختصاص جهة واحدة','تصعيد القضايا الاستراتيجية أو المؤسسية إلى مجلس نماء الأعلى'],
