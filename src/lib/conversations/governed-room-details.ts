...
export const governedRoomDetails:Record<ConversationRoomKey,GovernedRoomDetail>={
  ...
  operations:{
    ...
    entityTitle:'بنك نماء المركزي',
    responsibility:'استقبال رسائل المشتريات والحركات والإيصالات، استخراج بياناتها، منع التكرار، وربطها بالحساب أو البطاقة والتاجر قبل التصنيف والتسوية.',
    observes:'رسائل البنوك والمحافظ، الإيصالات، المبالغ، التجار، التواريخ، ومعرفات الحسابات والبطاقات المختصرة.',
    ...
    governanceNote:'هذه القناة الرسمية للعمليات. الرسالة المرسلة في أي دردشة أخرى يمكن توجيهها داخليًا هنا دون طلب إعادة الإرسال.',
