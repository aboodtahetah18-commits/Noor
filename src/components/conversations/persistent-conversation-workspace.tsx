...
const rooms: [Room, ...Room[]] = [
  { id:'central', title:'بنك نماء المركزي', subtitle:'الحوكمة والاستقرار', lead:'محافظ بنك نماء المركزي', specialists:'المحافظ وصاحب المسؤولية المختص، أو المستشار الاقتصادي عند الحاجة', avatar:'/brand/governor.webp', bankLogo:'/brand/bank-central.webp', building:'/brand/ndos/banks/namaa-central-bank-chat.webp' },
  { id:'operations', title:'مركز العمليات والمطابقة', subtitle:'الرسائل البنكية وكشوف الحسابات والمطابقة', lead:'مركز العمليات والمطابقة', specialists:'المطابقة والتسوية والتحقق مع استدعاء صاحب المسؤولية أو الجهة المختصة عند الحاجة', avatar:'/brand/governor.webp', bankLogo:'/brand/bank-central.webp', building:'/brand/ndos/banks/namaa-central-bank-chat.webp' },
  { id:'solvency', title:'بنك ملاءة', subtitle:'الحماية والاحتياطي', lead:'مدير بنك ملاءة', specialists:'مدير بنك ملاءة، ويستدعي مسؤول السيولة والحماية أو مسؤول الالتزامات عند صلة الموضوع', avatar:'/brand/malaa-manager.webp', bankLogo:'/brand/bank-malaa.webp', building:'/brand/ndos/banks/malaa-bank-chat.webp' },
  { id:'assets', title:'بنك الأصول الاستثماري', subtitle:'الأصول والأهداف والاستثمار', lead:'مدير بنك الأصول الاستثماري', specialists:'مدير بنك الأصول الاستثماري ومسؤول الاستثمار عند صلة الموضوع', avatar:'/brand/assets-manager.webp', bankLogo:'/brand/bank-assets.webp', building:'/brand/ndos/banks/investment-assets-bank-chat.webp' },
  { id:'hilal', title:'بنك الهلال', subtitle:'التمويل الداخلي', lead:'مدير بنك الهلال', specialists:'مدير بنك الهلال، ويستدعي مسؤول الالتزامات أو مسؤول الميزانية والإنفاق عند الحاجة', avatar:'/brand/hilal-manager.webp', bankLogo:'/brand/bank-hilal.webp', building:'/brand/ndos/banks/hilal-bank-chat.webp' },
  { id:'advisor', title:'المستشار الاقتصادي', subtitle:'تحليل الصورة المالية الكلية', lead:'المستشار الاقتصادي', specialists:'المستشار الاقتصادي، أو أحد أصحاب المسؤوليات المالية الخمسة بحسب موضوع الرسالة', avatar:'/brand/economic-advisor.webp', bankLogo:'/brand/namaa-logo.webp', building:'/brand/ndos/banks/namaa-central-bank-chat.webp' },
  { id:'secretary', title:'أمين السر المركزي', subtitle:'المحاضر والسياسات والاجتماعات', lead:'أمين السر المركزي', specialists:'أمين السر المركزي مع الجهة المختصة عند الحاجة', avatar:'/brand/governor.webp', bankLogo:'/brand/bank-central.webp', building:'/brand/ndos/banks/namaa-central-bank-chat.webp' },
  { id:'council', title:'مجلس نماء الأعلى', subtitle:'القرارات واللجان', lead:'محافظ بنك نماء المركزي بصفته رئيس المجلس', specialists:'أعضاء اللجنة ذات الصلة فقط، وليس جميع الشخصيات', avatar:'/brand/governor.webp', bankLogo:'/brand/bank-central.webp', building:'/brand/ndos/banks/namaa-central-bank-chat.webp' },
];
