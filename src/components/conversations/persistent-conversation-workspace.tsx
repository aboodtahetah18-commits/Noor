  ...
  return <section className={styles.page} dir="rtl" aria-label="محادثات نماء">
    ...
    <header className={styles.mobileAppBar}>
      <div className={styles.mobileAppBarPrimary}>
        ...
        <div className={styles.mobileBrandLockup} aria-label="نماء"><Image src="/brand/ndos/namaa-logo-official.png" alt="" width={32} height={32} priority/><span>نماء</span></div>
      </div>
