...
const rooms: [Room, ...Room[]] = [
  ...
  { id:'advisor', title:'المستشار الاقتصادي', subtitle:'تحليل الصورة المالية الكلية', lead:'المستشار الاقتصادي', specialists:'المستشار الاقتصادي، أو أحد أصحاب المسؤوليات المالية الخمسة بحسب موضوع الرسالة', avatar:'/brand/economic-advisor.webp', bankLogo:'/brand/ndos/namaa-logo-color-transparent.png', building:'/brand/ndos/banks/namaa-central-bank.jpg' },
