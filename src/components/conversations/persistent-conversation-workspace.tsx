...
function formatMessageTimestamp(value?:string){if(!value)return '';const date=new Date(value);if(Number.isNaN(date.getTime()))return '';return new Intl.DateTimeFormat('ar-SA',{day:'numeric',month:'short',year:'numeric',hour:'numeric',minute:'2-digit'}).format(date)}
  ...
  return <section className={styles.page} dir="rtl" aria-label="محادثات نماء">
    ...
    <header className={styles.mobileAppBar}>
      <div className={styles.mobileAppBarPrimary}>
        ...
        <div className={styles.mobileBrandLockup} aria-label="نماء"><Image src="/brand/namaa-leaf.webp" alt="" width={32} height={32} priority/><span>نماء</span></div>
      </div>
