...
export default function Page(){
  return <main className="namaa-governance-catalog page-shell" dir="rtl">
    <header className="namaa-governance-catalog-hero">
      <div><p>المعرفة المؤسسية</p><h1>الإجراءات التشغيلية</h1><span>الخطوات التنفيذية المرتبطة بكل سياسة ولائحة ومسؤولية.</span></div>
      <LucideIcon name="listChecks" size={24}/>
    </header>
    <section className="namaa-governance-catalog-grid">
      <article><span>المرجع</span><strong>الإجراءات</strong><p>يعرض هذا القسم المواد المعتمدة المرتبطة بهذا النوع من المعرفة.</p></article>
