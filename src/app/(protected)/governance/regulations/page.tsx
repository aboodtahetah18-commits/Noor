...
export default function Page(){
  return <main className="namaa-governance-catalog page-shell" dir="rtl">
    <header className="namaa-governance-catalog-hero">
      <div><p>المعرفة المؤسسية</p><h1>اللوائح التنظيمية</h1><span>تفصيل القواعد التنظيمية المرتبطة بالسياسات ومسارات التطبيق.</span></div>
      <LucideIcon name="receiptText" size={24}/>
    </header>
    <section className="namaa-governance-catalog-grid">
      <article><span>المرجع</span><strong>اللوائح</strong><p>يعرض هذا القسم المواد المعتمدة المرتبطة بهذا النوع من المعرفة.</p></article>
