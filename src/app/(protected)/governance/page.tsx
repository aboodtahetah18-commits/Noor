...
export default function GovernancePage(){
  ...
  return <main className="namaa-governance-portal page-shell namaa-migrated-shell namaa-page-stack" dir="rtl">
    <PageHeader
      className="namaa-governance-portal-hero namaa-migrated-header"
      eyebrow="المرجع المؤسسي"
      title="مكتبة المعرفة والحوكمة"
      description="الوصول المباشر إلى السياسات واللوائح والإجراءات النافذة، مع فصل واضح بين القراءة وإدارة الصلاحيات."
      actions={<div className="namaa-governance-portal-total"><strong>{total}</strong><span>وثيقة متاحة للاطلاع</span></div>}
    />
    ...
    <section className="namaa-governance-portal-grid">
      <article className="namaa-governance-library-card ux-card card-policy">
        ...
        <Link className="namaa-governance-open-library ux-button ux-button--secondary" href="/governance/policies">فتح مكتبة السياسات</Link>
      </article>

      <article className="namaa-governance-library-card ux-card card-regulation">
        ...
        <Link className="namaa-governance-open-library ux-button ux-button--secondary" href="/governance/regulations">فتح مكتبة اللوائح</Link>
      </article>

      <article className="namaa-governance-library-card ux-card card-procedure">
        ...
        <Link className="namaa-governance-open-library ux-button ux-button--secondary" href="/governance/procedures">فتح مكتبة الإجراءات</Link>
      </article>

      <article className="namaa-governance-library-card ux-card card-auth">
        ...
        <div className="namaa-governance-auth-actions">
          <Link className="ux-button ux-button--secondary" href="/governance/authorization-matrix">فتح مصفوفة الصلاحيات</Link>
          <Link className="ux-button ux-button--secondary" href="/governance/authorization">فتح إدارة الصلاحيات</Link>
        </div>
    ...
    <section className="namaa-governance-portal-footer ux-card">
      ...
      <Link className="ux-button ux-button--primary" href="/conversations">مناقشة وثيقة مع الجهة المختصة</Link>
    </section>
  </main>;
}
