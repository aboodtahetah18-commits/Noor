  ...
  return <>
    <header className="p47-mobile-topbar mustaqbali-mobile-header namaa-mobile-header" dir="rtl">
      <div className="mustaqbali-mobile-brand-zone">
        ...
        <Link href="/dashboard" className="mustaqbali-mobile-brand" aria-label="نماء — الرئيسية"><BrandLogo surface="auto" priority /></Link>
      </div>
      <div className="mustaqbali-mobile-header-actions"><ThemeToggle /><Link href="/alerts" aria-label="التنبيهات" title="التنبيهات"><LucideIcon name="bell" size={20}/></Link><ProfileTrigger profile={profile} className="mustaqbali-mobile-profile-trigger" /></div>
    </header>
