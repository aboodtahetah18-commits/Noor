...
const directChangeSchema=z.object({
  ...
  unitType:z.enum(['article','clause','paragraph','step','stage','category','reason','method','calculation','example']),
...
const createSchema=z.object({
  ...
  unitType:z.enum(['article','clause','paragraph','step','stage','category','reason','method','calculation','example']).default('paragraph'),
  currentRule:z.string().trim().max(4000).optional().nullable(),
