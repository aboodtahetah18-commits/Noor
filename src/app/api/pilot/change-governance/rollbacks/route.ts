...
import { recordAlgorithmRollback } from '@/features/pilot/services/algorithm-governance-write-service';
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const result = await recordAlgorithmRollback({ userId: user.id, ...parsed.data });
